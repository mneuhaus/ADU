...
For cases where you need to change Templates, Partials, Layouts or the whole
ViewClasses for a foreign package you can create a ``Views.yaml`` in your configuration.

	My:
	  Package:
	    'My\Package\Controllers\SomeController':
          viewClassName: '\TYPO3\TypoScript\View\TypoScriptView'
	      options:
	        typoScriptPathPatterns: resource://My.Package/Private/TypoScripts
