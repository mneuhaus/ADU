...
``Views.yaml``
  Contains configurations for Views. The Syntax is currently work in progress and
  subject to change. Take a look at the :ref:`_ch-model-view-controller` chapter for
  mor information.
